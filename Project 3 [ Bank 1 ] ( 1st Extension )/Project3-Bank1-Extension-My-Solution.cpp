...
bool WithdrawBalanceByAccountNumber(string AccountNumber, double Amount, vector <sClient>& vClients)
{
    char Answer = 'n';
    cout << "\n\nAre you sure you want perform this transaction? y/n? ";
    cin >> Answer;
...
void ShowWithdrawScreen()
{
    ...
    WithdrawBalanceByAccountNumber(AccountNumber, Amount, vClients);
}
...
void ShowTotalBalancesScreen()
{
    ...
    cout << "\t\t\t\t\t   ( " << NumberToText((long long)TotalBalances) << " )";
}
...
void PerfromTransactionsMenueOption(enTransactionsOptions TransactionOption)
{
...
void ShowTransactionsMenue()
{
    ...
    cin >> Choice;
    PerfromTransactionsMenueOption((enTransactionsOptions)Choice);
}
